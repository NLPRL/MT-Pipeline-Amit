...
for i in range(len(test_y_pred)):
    ...
    for j in range(len(test_y_pred[i])):
        ...
        outt2.append(class_labels[test_y_true[i][j]])
...
ff2 = open('vocabulary.txt','w', encoding='utf-8')
ff2.write(" ".join(vocab)+'\n')
ff2.write(" ".join(characters)+'\n')
ff2.write(" ".join(class_labels)+'\n')
ff2.write(" ".join(feat)+'\n')
ff2.flush()
ff2.close()
print(out[0])
...
print('\n---- Result of Loaded BiLSTM-CRF ------\n')
classification_report(ctest_y_true, ctest_y_pred2, class_labels)